...
Description         :   this will return all the cases for the associated equipment
...
from Database.db_queries import SELECTED_CASES_POSTGRES_QUERY
...
class GetCases(_PostGreSqlConnection):
    ...
    def get_cases_values(self):
        ...
        try:
            ...
            self._psql_session.execute(SELECTED_CASES_POSTGRES_QUERY.format(self.console, self.equipment))
...
@csrf_exempt
def get_selected_case(request, console=None, equipment=None):
    """
