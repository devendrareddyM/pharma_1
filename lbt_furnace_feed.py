...
from Database.db_queries import FURNACES_NAME
...
class lbt_furnace_feed(_PostGreSqlConnection):
    """
    ...
    def get_furnaces(self):
        ...
        try:
            ...
            try:
                self._psql_session.execute(FURNACES_NAME)
...
@csrf_exempt
def get_lbt_furnace_feed(request):
    """
